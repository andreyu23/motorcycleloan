<x-app-layout>
    ...
    <x-slot name="header">{{ __('Brothers/Sisters Information') }}</x-slot>
    <x-slot name="subHeader">{{ __('You can enter your brothers/sisters information and submit here.') }}</x-slot>
                            ...
                            <div class="card-inner">
                                <div class="nk-block">
                                    <div class="nk-block">
                                        ...
                                        <p>You can enter the details of your brothers/sisters here.</p>
                                    </div>
                                    ...
                                    @endif
                                    <form action="{{route('brosis.save')}}" method="POST" autocomplete="off">
                                        @csrf
                                        @include('pages.family-bg.brother-sister-form')
                                    </form>
                                    <br><br>
                                    @include('pages.family-bg.brother-sister-table')
                                </div>
                            </div>
                        </div>
                    </div>
