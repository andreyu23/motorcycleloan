...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap focused">
            ...
            <input required type="text" data-date-format="yyyy-mm-dd" placeholder="YYYY-MM-DD"
...
<div class="row mt-2 align-center">
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_pn">Driver License No. / Name <b
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_pa">Region <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="region" id="region" onchange="get_province(this.value)">
    ...
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_pa">Province <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="province" id="province" onchange="get_citymun(this.value)">
...
<div class="row mt-2 align-center">
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_pa">City or Municipality <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="citymun" id="citymun" onchange="get_brgy(this.value)">
    ...
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_pa">Barangay <b class="text-danger">*</b></label>
...
<div class="row mt-2 align-center">
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_px">House No., Street <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            ...
            <input required type="text" class="form-control" id="inp_px" name="inp_px"
    ...
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_px">Length of Service <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-1">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_px">Zip Code <b class="text-danger">*</b></label>
...
<div class="row mt-2 align-center">
    <h6 class="title overline-title text-danger text-base mb-4 ">
        Previous Address <small>(<label for="same_as_present_previous"> Same as Present Address</label> <input
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="region_previous" id="region_previous"
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="province_previous" id="province_previous"
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="citymun_previous" id="citymun_previous"
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="brgy_previous" id="brgy_previous">
                <option value="">- SELECT BARANGAY -</option>
            </select>
        </div>
...
<div class="row mt-2 align-center">
    <h6 class="title overline-title text-danger text-base mb-4 ">
        Provincial Address <small>(<label for="same_as_present_previous"> Same as Present Address</label> <input
                required type="checkbox" name="" id="same_as_present_previous"> )</small>
    </h6>
    <div class="col-lg-2">
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="region_provincial" id="region_provincial"
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="province_provincial" id="province_provincial"
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="citymun_provincial" id="citymun_provincial"
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            <select class="form-control" name="brgy_provincial" id="brgy_provincial">
                <option value="">- SELECT BARANGAY -</option>
            </select>
        </div>
...
<div class="row mt-2 align-center">
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            ...
            <input required type="text" class="form-control" id="inp_name" name="inp_name"
    ...
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_nad">Address <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            ...
            <input required type="text" class="form-control" id="inp_nad" name="inp_nad"
                placeholder="Enter (Required) nAddress here.. ">
        </div>
...
<div class="row mt-2 align-center">
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_ree">Relationship <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            ...
            <input required type="text" class="form-control" id="inp_ree" name="inp_ree"
    ...
    <div class="col-lg-2">
        ...
        <div class="form-group">
            <label class="form-label" for="inp_telx">Tel/Phone No. <b class="text-danger">*</b></label>
    ...
    <div class="col-lg-4">
        ...
        <div class="form-control-wrap">
            ...
            <input required type="text" class="form-control" id="inp_telx" name="inp_telx"
