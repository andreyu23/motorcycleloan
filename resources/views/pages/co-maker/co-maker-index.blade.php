<x-app-layout>
    ...
    <x-slot name="header">{{ __('Co-maker Background') }}</x-slot>
    <x-slot name="subHeader">{{ __('You can enter your co-maker`s background and submit here.') }}</x-slot>
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-inner">
                                <div class="nk-block">
                                    ...
                                    @endif
                                    <form action="{{route('comaker.save')}}" method="POST" autocomplete="off">
                                        @csrf
                                        @include('pages.co-maker.co-maker-form')
                                    </form>
                                    <br><br>
                                    @include('pages.co-maker.co-maker-table')
                                </div>
                            </div>
                        </div>
                    </div>
